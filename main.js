  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (FORMSPREE_ID) {
        ...
        // Honest fallback message: nothing was transmitted — the user's email app was opened.
        if (formSuccess) {
  ...
  if (dcStep1) {
    ...
    const repairData = {
      iphone: {
        label: 'iPhone',
        problems: [
          { id: 'screen', icon: 'broken_image', label: 'Cracked / broken screen', sub: 'By model — see pricing page', price: [100, 275], time: '45–60 min' },
          { id: 'battery', icon: 'battery_alert', label: 'Battery drains fast', sub: 'Swelling or short life', price: [70, 140], time: '30–45 min' },
          { id: 'charging', icon: 'bolt', label: 'Won\'t charge', sub: 'Port or cable issue', price: [125, 150], time: '45–60 min' },
          { id: 'water', icon: 'water_drop', label: 'Water damage', sub: '$95 treatment, credited', price: [95, 175], time: '1–3 hrs' },
          { id: 'camera', icon: 'broken_image', label: 'Camera not working', sub: 'Blurry, black, or cracked', price: null, time: '45–60 min' },
          { id: 'button', icon: 'touch_app', label: 'Buttons not responding', sub: 'Home, power, or volume', price: null, time: '30–45 min' },
          { id: 'speaker', icon: 'volume_off', label: 'No sound / speaker issue', sub: 'Muffled or silent', price: null, time: '30–45 min' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      },
      android: {
        label: 'Android Phone',
        problems: [
          { id: 'screen', icon: 'broken_image', label: 'Cracked / broken screen', sub: 'A-series from $145, S-series from $220', price: [145, 365], time: '60–90 min' },
          { id: 'battery', icon: 'battery_alert', label: 'Battery drains fast', sub: 'Swelling or short life', price: [110, 120], time: '30–45 min' },
          { id: 'charging', icon: 'bolt', label: 'Won\'t charge', sub: 'USB-C port issue', price: [125, 140], time: '45–60 min' },
          { id: 'water', icon: 'water_drop', label: 'Water damage', sub: '$95 treatment, credited', price: [95, 175], time: '1–3 hrs' },
          { id: 'camera', icon: 'broken_image', label: 'Camera not working', sub: 'Blurry, black, or cracked', price: null, time: '45–60 min' },
          { id: 'software', icon: 'restart_alt', label: 'Frozen / boot loop', sub: 'Won\'t start properly', price: [45, 99], time: '30–60 min' },
          { id: 'back', icon: 'screen_rotation', label: 'Back glass cracked', sub: 'Rear panel damage', price: null, time: '45–60 min' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      },
      laptop: {
        label: 'Laptop / PC',
        problems: [
          { id: 'screen', icon: 'broken_image', label: 'Broken / dim screen', sub: 'PC quoted per job; MacBook $360+', price: null, time: '1–2 hrs' },
          { id: 'battery', icon: 'battery_alert', label: 'Battery won\'t hold charge', sub: 'PC quoted; MacBook $170–265', price: null, time: '30–60 min' },
          { id: 'keyboard', icon: 'keyboard', label: 'Keyboard issues', sub: 'Sticky or dead keys', price: null, time: '1–2 hrs' },
          { id: 'slow', icon: 'speed', label: 'Running slow', sub: 'Tune-up or upgrades', price: [89, 99], time: '1–2 hrs' },
          { id: 'virus', icon: 'warning', label: 'Virus / malware', sub: 'Removal + tune-up, flat', price: [99, 99], time: '1–2 hrs' },
          { id: 'noboot', icon: 'restart_alt', label: 'Won\'t turn on', sub: '$45 diagnosis, credited', price: null, time: '1–3 hrs' },
          { id: 'water', icon: 'water_drop', label: 'Liquid spill', sub: '$95 treatment, credited', price: [95, 199], time: '2–4 hrs' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      },
      tablet: {
        label: 'iPad / Tablet',
        problems: [
          { id: 'screen', icon: 'broken_image', label: 'Cracked screen', sub: 'Standard from $155; laminated from $240', price: [155, 345], time: '60–90 min' },
          { id: 'battery', icon: 'battery_alert', label: 'Battery drains fast', sub: 'Short life', price: [150, 175], time: '45–60 min' },
          { id: 'charging', icon: 'bolt', label: 'Won\'t charge', sub: 'Micro-soldered port', price: [175, 180], time: '1–2 hrs' },
          { id: 'button', icon: 'touch_app', label: 'Button not working', sub: 'Home or power', price: null, time: '30–45 min' },
          { id: 'water', icon: 'water_drop', label: 'Water damage', sub: '$95 treatment, credited', price: [95, 175], time: '1–3 hrs' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      },
      console: {
        label: 'Game Console',
        problems: [
          { id: 'disc', icon: 'broken_image', label: 'Disc read errors', sub: 'Drive mechanism swap', price: [165, 180], time: '1–2 hrs' },
          { id: 'hdmi', icon: 'monitor', label: 'No video output', sub: 'HDMI port, micro-solder', price: [170, 175], time: '1–2 hrs' },
          { id: 'overheat', icon: 'warning', label: 'Overheating', sub: 'Deep clean + repaste', price: [85, 165], time: '1–2 hrs' },
          { id: 'drift', icon: 'touch_app', label: 'Controller drift', sub: 'Hall-effect sticks', price: [45, 90], time: '30–45 min' },
          { id: 'nopower', icon: 'restart_alt', label: 'Won\'t turn on', sub: 'Power supply issue', price: [150, 170], time: '1–2 hrs' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      },
      other: {
        label: 'Other Device',
        problems: [
          { id: 'screen', icon: 'broken_image', label: 'Screen / display issue', sub: 'Quoted by model', price: null, time: 'Varies' },
          { id: 'battery', icon: 'battery_alert', label: 'Battery issue', sub: 'Won\'t hold charge', price: null, time: 'Varies' },
          { id: 'nopower', icon: 'restart_alt', label: 'Won\'t turn on', sub: '$45 diagnosis, credited', price: null, time: 'Varies' },
          { id: 'other', icon: 'build', label: 'Something else', sub: 'Not listed above', price: null, time: 'Varies' }
        ]
      }
    };
    ...
    function generateResults() {
      ...
      selected.forEach(p => {
        ...
        const priceStr = p.price
          ? (p.price[0] === p.price[1] ? `$${p.price[0]}` : `$${p.price[0]}–$${p.price[1]}`)
        ...
        rowsHTML += `
          <div class="dc-estimate-row">
            ...
            <span class="dc-estimate-value">${priceStr}</span>
          </div>`;
      });
      ...
      dcResults.innerHTML = `
        ...
        <div class="dc-estimate-card">
          ...
          <div class="dc-estimate-card-footer">
            ...
            <span style="color: var(--accent);">${totalHigh > 0 ? `$${totalLow}${totalHigh > totalLow ? '–$' + totalHigh : ''}${anyQuoted ? ' + quoted items' : ''}` : 'Quoted after diagnosis'}</span>
          </div>
        </div>

        <p class="dc-results-note">
          ${condNotes[state.condition]}<br />
          This is an estimate based on common repairs — the full menu is on the <a href="/pricing">pricing page</a>. Final pricing is confirmed by text before any work. All repairs include a <strong>40-day warranty</strong>.
        </p>
...
(function() {
  ...
  {
    "name": "Back up an iPhone with a broken screen: what works",
    "desc": "Can you back up an iPhone when its screen is broken? Check existing iCloud copies, trusted-computer limits, working touch, and data-preserving repair options.",
    "href": "/tips/backup-iphone-broken-screen",
    "icon": "menu_book",
    "kw": " tips backup iphone broken screen"
  },
  {
  ...
  {
    "name": "Cracked screen protector or phone screen? How to tell",
    "desc": "Tell a cracked screen protector from damaged phone glass or display: inspect the edges, test the image safely, and know when removal needs a professional.",
    "href": "/tips/screen-protector-or-cracked-screen",
    "icon": "menu_book",
    "kw": " tips screen protector or cracked screen"
  },
  {
  ...
  {
    "name": "Laptop screen black but still running? Safe Windows checks",
    "desc": "Windows laptop lights or fans on but screen black? Test brightness, graphics response and an external display, then separate screen failure from a startup problem.",
    "href": "/tips/laptop-screen-black-but-running",
    "icon": "menu_book",
  ...
  {
    "name": "PS5 controller not charging? DualSense checks that help",
    "desc": "DualSense controller not charging? Isolate the cable, USB port and rest-mode power settings, read the battery indicator, and know when the controller needs service.",
    "href": "/tips/ps5-controller-not-charging",
    "icon": "menu_book",
    "kw": " tips ps5 controller not charging"
  },
  {
    "name": "PS5 not reading discs? Safe checks before a reset",
    "desc": "PS5 says unrecognized disc or will not read games? Check disc type, orientation, cleaning, a second disc and drive setup before risking saves or forcing the mechanism.",
    "href": "/tips/ps5-disc-not-reading",
    "icon": "menu_book",
    "kw": " tips ps5 disc not reading"
  },
  {
  ...
  {
    "name": "Spilled water or coffee on a laptop? What to do first",
    "desc": "Spilled water, coffee, or soda on a laptop? Disconnect power safely, avoid automatic restarts, protect your files, and understand why drying alone is not a repair.",
    "href": "/tips/spilled-liquid-on-laptop",
    "icon": "menu_book",
    "kw": " tips spilled liquid on laptop"
  },
  {
