    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (FORMSPREE_ID) {
        ...
        if (formSuccess) {
          ...
          msg.innerHTML = 'Your email app should have opened with your message pre-filled — hit send there to get it to me. If nothing opened, text <a href="sms:+12083666111">(208) 366-6111</a> or email <a href="mailto:samuel@haileyrepair.com">samuel@haileyrepair.com</a> directly.';
        }
        showFormSuccess();
      }
