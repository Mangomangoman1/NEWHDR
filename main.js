  ...
  var QF_DATA = {
    ...
    categories: [
      ...
      { title: 'Resources', icon: 'menu_book', links: [
        { name: 'Inside the Repair', desc: 'Explore MacBook and PS5 hardware', href: '/inside-the-repair', icon: 'memory', kw: 'inside repair interactive tour anatomy hardware bench parts components explore' },
